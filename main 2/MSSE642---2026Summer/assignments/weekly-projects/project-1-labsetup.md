...
- Suggestion: save image as `../images/Virtualbox.png` and insert below:

![VirtualBox showing Kali and Metasploitable2](../images/Virtualbox.png)
...
![Nessus Essentials dashboard](../images/nessus running.png)

## 6. Screenshot of Running Metasploitable2

Inserted screenshot showing the Metasploitable2 login shell.

![Metasploitable2 login shell](../images/Meta Running.png)
...
![Ping output showing connectivity](../images/Kali Ping Meta.png)
