...
- **Vulnerable Admin Panel**  
  ![Vulnerable Admin Panel](../images/vulnerable admin login.jpeg)

- **Full Stack Trace Leak**  
  ![Full Stack Trace Leak](../images/vulnerable stack trace.jpeg)

- **Environment Variables Leak**  
  ![Environment Variables Leak](../images/vulnerable env leak .jpeg)

- **Vulnerable Landing Page**  
  ![Vulnerable Landing Page](../images/Vulnerable mode.jpeg)
...
- **Secure Login Page**  
  ![Secure Login Page](../images/Secure success login.jpeg)

- **Secure Admin Panel**  
  ![Secure Admin Panel](../images/secure admin login.jpeg)

- **Sanitized Error Message**  
  ![Sanitized Error Message](../images/secure error.jpeg)

- **Secure Landing Page**  
  ![Secure Landing Page](../images/Secure.jpeg)
