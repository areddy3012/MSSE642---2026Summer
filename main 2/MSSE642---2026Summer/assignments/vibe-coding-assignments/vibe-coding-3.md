...
![Vulnerable Login](../images/Authentication page.png)

### 2. Hardcoded Credentials in `script.js`  
![Hardcoded Creds](../images/hardcoded credentials.png)

### 3. Detailed Error Messages  
![Vulnerable Error](../images/vulnerbale error.jpeg)

### 4. Weak Password Login Success  
![Weak Password Success](../images/vulnerable mode login.png)
...
### 5. Secure Login Page  
![Secure Login](../images/secure mode login.png)

### 6. Generic Error Message  
![Secure Error](../images/secure login error.jpeg)

### 7. Rate Limiting  
![Rate Limit](../images/secure rate limit.jpeg)

### 8. Hashed Passwords in `server.js`  
![Hashed Passwords](../images/hashed password.png)
