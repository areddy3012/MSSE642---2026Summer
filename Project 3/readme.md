...
`![Kali IP Output](screenshots/kali ip.png)`
...
*Screenshot Placeholder:*  
`![Metasploitable IP Output](screenshots/meta ip.png)`
...
*Screenshot Placeholder:*  
`![Kali VirtualBox Network Settings](screenshots/kali network settings.png)`

---

### 4.2 Metasploitable2 VirtualBox Adapter Settings
*Screenshot Placeholder:*  
`![Metasploitable VirtualBox Network Settings](screenshots/meta network settings.png)`
...
## **6. SYN Scan Results**
*Screenshot Placeholder:*  
`![SYN Scan Output](screenshots/scan results.png)`
